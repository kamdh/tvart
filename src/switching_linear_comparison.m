...
N_vec = [6,10,14,18,20,30,50,80,100,200,400,1000,2000,4000,8000];
...
err_table = zeros(T * 3 * length(N_vec), 3 + 5);
row = 0;
N_idx = 0;
...
for N = N_vec
    ...
    %             noise_std), 'X', 'A1', 'A2');
    load(sprintf('../data/test_data_N_%d_M_%d_sigma_%f.mat', N, num_steps, ...
                 noise_std));
